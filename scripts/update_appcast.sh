...
echo "
    <item>
      ...
      <sparkle:releaseNotesLink>https://ztabby.app/changelog-bare</sparkle:releaseNotesLink>
      <enclosure
        url=\"https://github.com/lwouis/ztabby/releases/download/v$version/$zipName\"

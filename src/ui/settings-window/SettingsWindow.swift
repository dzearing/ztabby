...
class SettingsWindow: NSWindow {
    ...
    private let quitButton = NSButton(title: String(format: NSLocalizedString("Quit %@", comment: "%@ is Ztabby"), App.name), target: nil, action: #selector(NSApplication.terminate(_:)))

...
class ShowHideIllustratedView {
    ...
    private func setupItems() {
        ...
        hideStatusIcons.subTitle = NSLocalizedString("Ztabby will show if the window is currently minimized or fullscreen with a status icon.", comment: "")
        ...
        let featureUnavailable = NSLocalizedString("Ztabby is currently set to show Applications. This setting is only available when Ztabby is set to show Windows.", comment: "")
        ...
        showTabsAsWindows.subTitle = NSLocalizedString("Some apps like Finder or Preview use standard tabs which act like independent windows. Some other apps like web browsers use custom tabs which act in unique ways and are not actual windows. Ztabby can't list those separately.", comment: "")
